...
import { FaUser, FaLock, FaEye, FaEyeSlash, FaArrowRight, FaGoogle, FaFacebook } from 'react-icons/fa';
...
const UserLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-darkblack-900 via-darkblack-800 to-primarygreen-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        {/* Header */}
        <div className="text-center">
          <div className="mx-auto h-16 w-16 bg-gradient-to-r from-darkblack-700 to-primarygreen-600 rounded-full flex items-center justify-center mb-6">
